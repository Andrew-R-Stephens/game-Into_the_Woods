...
public class TestLevel2 extends ALevel {
    ...
    public void build() {
        // Wall
        addProp(new Platform(getResources(),0, 0, 100, 1080, 0, 0, false));
        addProp(new Platform(getResources(),0, 0, 100, 1080, 0, 0, false));
        // Climbing Walls
        addProp(new Platform(getResources(),100, -150, 50, 200, 0, 0, false));
        addProp(new Platform(getResources(),200, 0, 50, 200, 0, 0, false));
        addProp(new Platform(getResources(),300, 220, 50, 200, 0, 0, false));
        addProp(new Platform(getResources(),400, 360, 50, 200, 0, 0, false));
        addProp(new Platform(getResources(),500, 500, 50, 200, 0, 0, false));
