...
public class TestLevel1 extends ALevel {
    ...
    public void build() {
        ...
        // Walls
        addProp(new Platform(-500, 0, 500, 1080, 0, 0, false));
        ...
        // Climbing Walls
        addProp(new Platform(320, -150, 50, 200, 0, 0, false));
        addProp(new Platform(500, 0, 50, 200, 0, 0, false));
        addProp(new Platform(320, 220, 50, 200, 0, 0, false));
        addProp(new Platform(500, 360, 50, 200, 0, 0, false));
        addProp(new Platform(320, 500, 50, 200, 0, 0, false));
        ...
        // Door
        door = new Door(gameEnvironment, 2000, 0, 50, 100,
                        0, 0, 1, false, false);
        addProp(door);
        ...
        // Springs
        addProp(new Spring(gameEnvironment, 1000, 280, 100, 20, 0, 0, -1,false, false));
        addProp(new Spring(gameEnvironment, 1200, 280, 100, 20, 0, 0, -1,false, false));
        addProp(new Spring(gameEnvironment, 1400, 280, 100, 20, 0, 0, -1,false, false));
        addProp(new Spring(gameEnvironment, 300, 580, 100, 20, 0, 0, -1,false, false));
        addProp(new Spring(gameEnvironment, 1000, 180, 100, 20, 0, 0, -1,false, false));
        addProp(new Spring(gameEnvironment, 100, 680, 100, 20, 0, 0, -1,false, false));

        // Spikes
        addProp(new Spikes(gameEnvironment, 1000, 930, 100, 50, 0, 0, -1));
        addProp(new Spikes(gameEnvironment, 1200, 960, 100, 20, 0, 0, -1));
        addProp(new Spikes(gameEnvironment, 1400, 905, 100, 75, 0, 0, -1));

        // Keys
        addProp(new DoorKey(gameEnvironment, 1600, 750, 100, 50, 0, 0));
        addProp(new DoorKey(gameEnvironment, 2500, 450, 100, 50, 0, 0));
        addProp(new DoorKey(gameEnvironment, 500, 300, 100, 50, 0, 0));
